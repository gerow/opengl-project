...
public class Neptune extends Planet {
    public static final float SCALING_FACTOR = Sun.SCALE_FACTOR * 0.3f;
	...
	mat.shininess = 40.0f;
	try {
	    mat.texture = TextureLoader.loadTexture("neptune.jpg");
	} catch (GLException e) {
	    // TODO Auto-generated catch block
	    e.printStackTrace();
	} catch (IOException e) {
	...
	this.function = new RealToVector3fFunction() {
		...
		float x = (float) (a * Math.cos(1.6*t));
		float y = (float) (b * Math.sin(1.6*t));
